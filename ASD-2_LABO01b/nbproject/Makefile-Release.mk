...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/asd-2_labo01b.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/asd-2_labo01b.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/asd-2_labo01b ${OBJECTFILES} ${LDLIBSOPTIONS}
